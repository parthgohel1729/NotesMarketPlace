...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/notesunderreview.css">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>InReview</td>
                        <td><a class="btn btn-success" role="button" title="Approve">Approve</a><a class="btn btn-danger" role="button" title="Approve">Reject</a><a class="btn btn-secondary" role="button" title="Approve">InReview</a></td>
                        <td class="act">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownDotLink1">
                                    <a class="dropdown-item same" href="#">Download Notes</a>
                                </div>
                            </div>
                        </td>
                    </tr>
    ...
    <!-- Custom JS -->
    <script src="js/notesunderreview.js"></script>
